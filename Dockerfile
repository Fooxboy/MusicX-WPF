...
RUN dotnet restore SignalR.Protobuf/SignalR.Protobuf.csproj

COPY MusicX.Shared/MusicX.Shared.csproj MusicX.Shared/ 
RUN dotnet restore MusicX.Shared/MusicX.Shared.csproj

COPY MusicX.Server/MusicX.Server.csproj MusicX.Server/
RUN dotnet restore MusicX.Server/MusicX.Server.csproj
