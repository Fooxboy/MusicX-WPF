...
public abstract class BoomViewModelBase : BaseViewModel
{
    ...
    public virtual async Task ArtistSelected()
    {
        try
        {
            ...
            await PlayerService.PlayAsync(new RadioPlaylist(BoomService, new(radioByArtist, BoomRadioType.Artist)));
    ...
    public virtual async Task TagSelected()
    {
        try
        {
            ...
            await PlayerService.PlayAsync(new RadioPlaylist(BoomService, new(radio, BoomRadioType.Tag)));
